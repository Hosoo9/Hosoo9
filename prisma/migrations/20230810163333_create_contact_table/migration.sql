...
-- AddForeignKey
ALTER TABLE [dbo].[Contact] ADD CONSTRAINT [Contact_operationId_fkey] FOREIGN KEY ([operationId]) REFERENCES [dbo].[Operation]([id]) ON DELETE NO ACTION ON UPDATE CASCADE;
