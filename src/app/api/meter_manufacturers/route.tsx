...
import { createManufacturer, findMeterManufacturers } from "@/contexts/meter_manufacturer"
...
export async function GET(request: NextRequest) {
  ...
  const manufacturers = await findMeterManufacturers()
...
export async function POST(request: NextRequest) {
  try {
    ...
    const manufacturer = await createManufacturer(params)
